...
export default function Login(): JSX.Element {
  return (
    <main className="h-screen w-screen flex flex-col justify-center">
      <section className=" w-[90%] m-auto  max-w-[27rem] flex flex-col items-center justify-center md:bg-gray-100 p-7 pt-4 md:border border-gray-300 rounded-md md:shadow-lg ">
